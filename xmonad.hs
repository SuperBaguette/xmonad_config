...
------------------------------------------------------------------------
    ...
    , ((modm .|. shiftMask,     xK_p     ), spawn "rofi -show drun -run-command gksudo {cmd}")
...
------------------------------------------------------------------------
    , ((modm .|. controlMask,   xK_q     ), spawn "qutebrowser")
    , ((modm .|. controlMask,   xK_b     ), spawn "bitwarden-desktop")
    , ((modm .|. controlMask,   xK_f     ), spawn "thunar")
    , ((modm .|. controlMask,   xK_i     ), spawn "discord")
    , ((modm .|. controlMask,   xK_m     ), spawn "MellowPlayer")
    , ((modm .|. controlMask,   xK_s     ), spawn "steam")
    , ((modm .|. controlMask,   xK_t     ), spawn "gnome-todo")
    , ((modm .|. controlMask,   xK_k     ), spawn "kodi")

-----------------------------------------------------------------------
-- Application command bindings
-----------------------------------------------------------------------
    -- Variety: go to next & previous wallpapers
    , ((modm .|. controlMask,   xK_Right ), spawn "variety -n")
    , ((modm .|. controlMask,   xK_Left ), spawn "variety -p")
...
------------------------------------------------------------------------
-- Bindings for workspaces & screens
------------------------------------------------------------------------
